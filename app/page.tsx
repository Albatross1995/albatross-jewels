...
useEffect(() => {
  if (products.length > 0) {
...
}, [products]);
    {
      ...
      category: "Chain",
description: "Premium Artificial Gold Plated, Anti Tarnish, Daily Wear Chain",
    },
    {
      name: "Rose Gold Ring",
      price: 499,
      image: "/products/rose-gold-ring.jpeg",
       category: "Ring",
       description: "Elegant Rose Gold Ring- Anti Tarnish, Daily Wear",
    },
    {
      name: "Swan Gold Ring",
      price: 999,
      ...
      category: "Ring",
      description: "Graceful Swan Gold Ring, Anti Tarnish, Daily Wear",
    },
    {
